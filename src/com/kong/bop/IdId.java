...
public class IdId {
	...
	public static void main(String[] args) {
		...
		//2140251882, 2140251883 //  2126125555, 2153635508L//1970381522, 2162351023L // 2125894967L, 1970033396L // 2292217923L, 2100837269 // 2151561903L, 2015720094
		// 2146007994, 2100837269跑不出来 //2332023333L,2100470808
		// 2147152072L, 189831743
		reqNum = 0;
		long start = System.currentTimeMillis();
		List<List<Long>> result = Calculate(httpclient,2126125555, 2153635508L);//2088608143, 2058000726);
...
//		System.out.println(result.toString());
	...
	public static List<List<Long>> Calculate(HttpClient httpclient, long Id1, long Id2) {
		...
		String expr = "Or(Id=" + Id1 + ",Id=" + Id2 + ")&count=10000&attributes=Id,RId,F.FId,J.JId,C.CId,AA.AuId";
